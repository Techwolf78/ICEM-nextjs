...
export default function FeesRegulatingAuthority() {
  const [selectedPdf, setSelectedPdf] = useState(null);

  const pdfFiles = [
    {
      name: "FRA Proposal 2025–26",
      file: "/pdfs/FRA-Proposal-2025-26.pdf",
    },
    {
      name: "FRA Report 2024–25",
      file: "/pdfs/FRA2024-25.pdf",
    },
  ];
  ...
  return (
    <main className="max-w-6xl mx-auto px-4 py-10 text-gray-800">
      <h1 className="text-3xl sm:text-4xl font-bold text-secondary mb-8">
        Fees Regulating Authority Documents
      </h1>
