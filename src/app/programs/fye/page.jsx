        ...
        <div className="relative max-w-[1500px] px-6 md:px-12 lg:px-20 z-20">
          <div className="max-w-3xl text-white">
            ...
            <p className="mt-4 text-white/80 leading-relaxed max-w-2xl">
              This common first year is meticulously designed to provide a
              strong grounding in fundamental engineering sciences, mathematics,
              and core concepts. It empowers students with the critical thinking
              and problem-solving skills essential for success in their chosen
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 px-6">
          <div>
            ...
            <p className="text-gray-700">
              A foundational 1-year programme common to all undergraduate
              engineering streams.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-700">
              Hands-on sessions in basic engineering workshops and
              physics/chemistry labs to bridge theory with practice.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-700">
              Successful completion allows students to seamlessly transition
              into their specialized engineering branch (e.g., Computer,
              Mechanical, IT, ENTC).
            </p>
          </div>
      ...
      <div className="w-full bg-[#f7f7f7] py-16 text-black">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-700 max-w-3xl mx-auto mb-12 leading-relaxed">
            Our First Year programme is more than just a syllabus; it's an
            initiation into the engineering mindset, designed to build a
            powerful platform for future academic and professional success.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="p-6 text-left">
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  <span className="font-bold">
                    A Unified Scientific Base :{" "}
                  </span>
                  Develop a formidable understanding of mathematics and basic
                  sciences, which form the essential language and tools for all
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all">
              ...
              <div className="p-6 text-left">
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  <span className="font-bold">Discover Your Passion : </span>{" "}
                  Get exposure to various engineering fields through
                  introductory modules and projects, enabling you to choose your
                  specialized branch with clarity and confidence.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all">
              ...
              <div className="p-6 text-left">
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  <span className="font-bold">Beyond the Textbook : </span>
                  Cultivate essential soft skills, including technical
                  communication, teamwork, and problem-solving, which are
                  critical for a holistic engineering education.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 px-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              The common first year is a strategic phase that prepares you not
              just for a degree, but for a dynamic career. It ensures you build
              the right foundation before diving deep into a specialized field.
            </p>
