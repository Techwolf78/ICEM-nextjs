        ...
        <div className="relative max-w-[1500px] px-6 md:px-12 lg:px-20 z-20">
          <div className="max-w-3xl text-white">
            ...
            <p className="mt-4 text-white/80 leading-relaxed max-w-2xl">
              This programme provides a robust foundation in software
              development, network systems, and data management, integrated with
              cutting-edge expertise in cloud computing, cybersecurity, and
              enterprise IT solutions. It prepares students to manage and
              optimize the technology infrastructure that drives modern
              organizations.
            </p>
