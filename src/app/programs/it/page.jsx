  ...
  <div className="absolute inset-0">
    <Image
      ...
      className="
        object-cover 
        object-center 
        md:object-[60%]      /* fixes small desktop crop */
        scale-100 
        md:scale-105 
        lg:scale-110 
        opacity-90
  ...
  <div className="relative max-w-[1400px] px-4 sm:px-6 md:px-10 lg:px-20 z-20">
    <div className="max-w-2xl md:max-w-xl lg:max-w-3xl text-white">
      ...
      <h2
        ...
        "
      >
        4-Year B.E. Information Technology Programme
      ...
      <p
        ...
        "
      >
        This programme provides a robust foundation in software development, network
        systems, and data management, integrated with cutting-edge expertise in cloud
        computing, cybersecurity, and enterprise IT solutions. It prepares students to
        manage and optimize the technology infrastructure that drives modern
        organizations.
      </p>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 px-6">
          <div>
            ...
            <p className="text-gray-700">
              A comprehensive 4-year curriculum designed to build proficiency in
              IT systems, software engineering, and infrastructure management.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-700">
              Students undertake a 6-month internship with leading IT services,
              consulting firms, and corporate IT divisions to gain industry
              experience.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-700">
              Excellent placement record with top IT services companies, MNCs,
              and tech startups seeking skilled IT professionals.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm flex flex-col justify-between border border-gray-100">
            <div>
              ...
              <p className="text-gray-700 mb-6 leading-relaxed text-sm sm:text-base">
                This programme equips students with comprehensive knowledge of
                software engineering, database management, network security, and
                web technologies. The curriculum emphasizes practical IT
                solutioning, ensuring graduates can design, implement, and
                manage secure and scalable business systems.
              </p>
      ...
      <div className="w-full bg-[#f7f7f7] py-16 text-black">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-700 max-w-3xl mx-auto mb-12 leading-relaxed">
            Our B.E. in Information Technology blends core computing principles
            with specialized training in enterprise-grade technologies. The
            programme is designed to create IT professionals who can bridge the
            gap between business needs and technological implementation.
          </p>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all">
              ...
              <div className="p-6 text-left">
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  ...
                  The curriculum builds expertise in software development,
                  network architecture, and database systems, forming the
                  foundation for implementing and managing large-scale IT
                  solutions.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all">
              ...
              <div className="p-6 text-left">
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  ...
                  Gain hands-on experience in our networking, cybersecurity, and
                  cloud computing labs, equipped with industry-standard tools
                  for system administration, development, and security auditing.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all">
              ...
              <div className="p-6 text-left">
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  ...
                  Through live projects and internships, students develop
                  practical skills in system integration, software development
                  life cycles, and IT service management, making them assets to
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 px-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              Information Technology graduates are pivotal across all sectors,
              including finance, healthcare, e-commerce, and consulting. They
              are equipped for roles that involve developing software, managing
              IT infrastructure, and ensuring the security and efficiency of
              business operations.
            </p>
