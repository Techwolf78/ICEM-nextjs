...
export default function Mech() {
  ...
  const handleBrochureDownload = () => {
    ...
    link.href = "/BEComp.pdf"; // ✅ Use public folder path directly
    link.download = "ICEM_Mechanical_Engineering_Brochure.pdf"; // ✅ Updated filename
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10 px-6">
          ...
          <div className="flex-1">
            <h2 className="text-3xl md:text-4xl font-bold leading-snug">
              4-Year B.E. Mechanical Program <br />
              with specialisation in <br />
              <span className="text-secondary">
                Machines & Future Technologies
              </span>
            </h2>
