    ...
    <div className="bg-white p-6 rounded-lg shadow-sm flex flex-col justify-between border border-gray-100">
      <div>
        ...
        <p className="text-gray-700 mb-6 leading-relaxed text-sm sm:text-base">
          This programme enables students to deepen their expertise in advanced algorithms, distributed systems, 
          artificial intelligence, and cybersecurity. It is research-oriented, designed to create technology leaders 
          capable of solving complex computational problems and driving future innovations.
        </p>
