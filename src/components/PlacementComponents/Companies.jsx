  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-4 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-7 gap-x-1 gap-y-2 sm:gap-x-2 sm:gap-y-4 place-items-center relative">
          {reorderedLogos.map((logo, index) => (
            <div
              key={index}
              className={`group flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-white rounded-xl shadow-sm hover:shadow-xl hover:scale-105 transition-all duration-300 ease-out border border-gray-200 hover:border-primary sm:px-1 ${
