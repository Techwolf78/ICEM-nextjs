...
const WhatsAppButton = () => {
  return (
    <>
      ...
      <motion.div
        className="fixed bottom-14 right-3 md:hidden z-50"
        initial={{ x: 100, opacity: 0 }}
        animate={{ x: [0, -5, 5, -5, 5, 0], opacity: 1 }}
        transition={{ delay: 5, duration: 0.5, repeat: Infinity, repeatDelay: 3, ease: "easeOut" }}
      ...
      >
        <a
          ...
          aria-label="Chat with ICEM Admission on WhatsApp"
          title="Chat with ICEM Admission"
        >
          <svg
