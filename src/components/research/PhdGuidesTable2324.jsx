// PhdGuidesTable2324.jsx
export default function PhdGuidesTable2324() {
  const facultyData = [
    {
      id: 1,
      ...
      scholars: [
        {
          ...
          year: "22-03-2020",
          thesis: "An Intelligent DocBot For Healthcare Application"
        },
        {
          name: "Shweta Nishit Jain",
          year: "22-03-2020",
          thesis: "Novel Predictive Models for Alzheimer's Disease Detection using Brain MRI Analysis"
        },
        {
          name: "Prajwal Gaikwad",
          year: "09-04-2020",
          thesis: "Artificial Intelligence Based Deep Learning Model for classification of white blood cells"
        },
        {
          name: "Pragati Mahale",
          year: "09-04-2020",
          thesis: "Classification of Human Blood Cells, Using Deep Learning Models"
        },
        {
          name: "Minal Zope",
          year: "09-04-2020",
          thesis: "Classification of abnormalities associated with Alzimers' Disease using techniques based on Artificial Intelligence"
        },
        {
          name: "Prakash Krishna Shinde",
          year: "01-03-2020",
          thesis: "Quality Of Service and Security Aware Blockchain-Based Internet of Vehicle Network In Cloud Computing"
        }
      ]
    }
  ];
      ...
      <table className="w-full border-collapse border border-gray-300 text-sm">
        <thead>
          <tr className="bg-secondary text-white">
            ...
            <th className="border border-gray-300 p-3 text-left">Title of the thesis of the scholar</th>
          </tr>
        </thead>
        <tbody>
